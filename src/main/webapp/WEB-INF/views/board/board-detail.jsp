...
<body>
    ...
    <script>
        ...
        //수정버튼
        $modBtn.onclick = e => {
            location.href = '/board/modify?boardNo=${b.boardNo}&fm=modify';
        };
        ...
        $delBtn.onclick = e => {
            ...
            location.href = '/board/delete/${b.boardNo}';
        };
        //목록버튼
        $listBtn.onclick = e => {
            location.href = '/board/list?pageNum=${p.pageNum}&amount=${p.amount}&sort=${p.sort}';
        };
    </script>
