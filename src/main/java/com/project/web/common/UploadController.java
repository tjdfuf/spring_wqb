...
import com.project.web.util.FileUtils;
...
public class UploadController {
    ...
    // 업로드 파일 저장 경로
    private static final String UPLOAD_PATH = "C:\\SR\\upload";
    ...
    /*
        ...
        이 객체는 응답 body정보 이외에도 header 정보를 포함할수있고
        추가로 응답 상태 코드도 제어할수있다
     */
